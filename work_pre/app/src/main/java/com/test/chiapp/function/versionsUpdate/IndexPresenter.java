package com.test.chiapp.function.versionsUpdate;
...
public class IndexPresenter implements IndexContract.Presenter {
    ...
    public void checkUpdate(String local) {
        //假设获取得到最新版本
        //一般还要和本机的版本做比对。。这里就不累赘了
        String version = "2.0";//新版本  local 本地版本 也可以在本地存一个忽略版本
         view.showUpdate(version);
    }
    @Override
    public void setIgnore(String version) {//设置忽略版本
